/**
 * Persistence foundation (U7) — the versioned doc shape + parse-on-load
 * validation. Save/load plumbing is deferred; these assert the safety hook a
 * future load path relies on.
 */
