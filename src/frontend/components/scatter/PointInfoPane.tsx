...
export function PointInfoPane({
    ...
    return (
        ...
        >
            {/* Header */}
            <p className="mb-1.5 font-sans font-semibold text-[9px] text-muted-foreground uppercase tracking-widest">
                Point
            </p>
            ...
            <div className="flex flex-col gap-0.5">
                {fields.map((key) => (
                    <div key={key} className="flex items-baseline justify-between gap-3">
                        <span className="max-w-[90px] truncate text-muted-foreground/70">
                            {key}
                        </span>
