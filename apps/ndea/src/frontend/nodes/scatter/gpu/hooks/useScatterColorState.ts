...
import { type CategoryMapping, makeCategoryColumn } from "@/lib/color/category-column";
import { type ColorSource, colorSourceFromString, colorSourceToString } from "@/lib/color/color-source";
import { toRows } from "@/lib/mosaic-helpers";
import { pickDefaultCategoricalPalette } from "@/lib/color/ochre-palette";
