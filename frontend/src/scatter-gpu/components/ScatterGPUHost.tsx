...
export const ScatterGPUHost = forwardRef<ScatterGPUHostHandle, ScatterGPUHostProps>(
    function ScatterGPUHost({ data, positionKey, config, onGpuError, onRowIndicesChange }, ref) {
