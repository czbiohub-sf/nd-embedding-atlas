        ...
        return (
            <div className="flex h-full flex-col items-center justify-center gap-3 text-center">
                <span className="select-none text-[11px] text-muted-foreground/50">
                    Click a point, then{" "}
                    <span className="text-muted-foreground/70">→ Show Trajectory</span> to start
                    tracking
                </span>
            </div>
        );
    ...
    return (
        <div className="flex h-full flex-col overflow-hidden">
            ...
            <div className="flex shrink-0 items-center gap-2 border-border/40 border-b bg-muted/10 px-3 py-1.5 text-[10px]">
                ...
                <span className="max-w-[180px] truncate text-muted-foreground/50">
                    {trajectory.fovName}
                </span>
                <span className="text-muted-foreground/30">·</span>
            ...
            <div className="flex shrink-0 items-center gap-2 border-border/30 border-b px-3 py-1.5">
                ...
                <input
                    ...
                    style={{ height: "3px" }}
                />
                <span className="min-w-[36px] text-right text-[10px] text-primary/70 tabular-nums">
                    {trajectory.tIndex}
                </span>
