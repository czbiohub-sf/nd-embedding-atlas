...
export function BottomDock({
    ...
    return (
        <div className="flex h-6 shrink-0 items-center gap-0 border-white/[0.07] border-t bg-card/80 px-2 text-[11px] text-muted-foreground backdrop-blur-md">
                    ...
                    >
                        <span
                            ...
                            style={{
                                ...
                                boxShadow:
                                    activePanelId === p.id
                                        ? `0 0 6px 1px ${colorForIndex(p.colorIndex!)}40`
                                        : "none",
                            }}
                        />
                    </TooltipTrigger>
            ...
            {hasPlate && onFloatViewer && (
                <Tooltip>
                    ...
                    >
                        ...
                        <span
                            aria-hidden="true"
                            className="absolute -top-0.5 -right-0.5 size-1.5 rounded-full bg-primary/70"
                        />
                    </TooltipTrigger>
            ...
            {selectedCount !== null && selectedCount > 0 && (
                <>
                    ...
                    <span
                        ...
                        style={{ color: "oklch(0.585 0.233 277.117 / 80%)" }}
                    >
            ...
            <Tooltip>
                <TooltipTrigger
                    render={<span className="cursor-default text-muted-foreground/75" />}
                >
