    ...
    return (
        <div className="flex flex-col overflow-hidden rounded-lg border border-white/[0.07] bg-card/80 backdrop-blur-md">
            ...
            <div className="flex shrink-0 items-center gap-1.5 px-2 py-1.5">
                ...
                <span className="flex-1 font-medium text-[10px] text-muted-foreground/70">
                    Channels
                </span>
                <button
                    type="button"
                            ...
                            <div key={ch.label} className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-1.5">
                                    <Toggle
                                        ...
                                        pressed={ch.visible}
                                        onPressedChange={(v) =>
                                            actions.setChannelProp(i, { visible: v })
                                        }
                                    ...
                                    <span className="flex-1 truncate text-[10px] text-foreground/80">
                                        {ch.label}
                                    </span>
