    ...
    return (
        <div className="h-full overflow-y-auto bg-[#0d0d14] text-white">
            <Section title="Brush Predicate Store">
                ...
                <Row
                    label="predicate"
                    value={brush.predicate ?? <span className="text-white/20">null</span>}
                />
            ...
            <Section title="Selection Sync Store">
                <Row
                    ...
                    value={
                        <span
                            className={
                                selection.type === "active" ? "text-purple-400" : "text-white/30"
                            }
                        >
                            {selection.type}
                        </span>
                ...
                {selection.type === "active" && (
                    <>
                        ...
                        <Row
                            label="version"
                            value={<span className="text-purple-400">{selection.version}</span>}
                        />
                        {(() => {
            ...
            <Section title="View Sync Store">
                <Row
                    ...
                    value={
                        <span
                            className={
                                view.lockMode === "linked" ? "text-cyan-400" : "text-white/30"
                            }
                        >
                            {view.lockMode}
                        </span>
                ...
                <Row
                    label="sourcePanelId"
                    value={view.sourcePanelId ?? <span className="text-white/20">null</span>}
                />
