...
export default defineConfig({
  ...
  fmt: {
    ...
    // .bunli/commands.gen.ts is regenerated by `bunx bunli generate` and
    // carries embedded JSON literals + raw AST nodes — fmt would rewrite
    // shapes the generator overwrites on the next run.
