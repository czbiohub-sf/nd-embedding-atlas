...
import { getNetworkAddress } from "../src/cli/resolve.ts";
import { resolveFrontendDir } from "../src/server/static.ts";
...
`;
  ...
  test("rejects missing file", async () => {
    await expect(loadProjectConfig("/nonexistent/config.yaml")).rejects.toThrow("Config file not found");
  });
